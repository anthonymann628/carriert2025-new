...
public class RouteCalculator{
	...
	public void calculateRouteWithWaypoints(List<Waypoint> waypointsFromImportedLocations, CalculateRouteCallback calculateRouteCallback){
		CarOptions routingOptions = new CarOptions();
		routingOptions.routeOptions.enableRouteHandle = true;

		routingEngine.calculateRoute(waypointsFromImportedLocations, routingOptions, calculateRouteCallback);
	}

	public void importRoute(List<Location> importedLocations, CalculateRouteCallback calculateRouteCallback){
		CarOptions routingOptions = new CarOptions();
		routingOptions.routeOptions.enableRouteHandle = true;

		routingEngine.importRoute(importedLocations, routingOptions, calculateRouteCallback);
	}
}
