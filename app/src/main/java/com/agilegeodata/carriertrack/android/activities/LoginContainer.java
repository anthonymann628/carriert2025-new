...
public class LoginContainer extends Activity{

	private static final String TAG = LoginContainer.class.getSimpleName();
	...
	public void onResume(){
		super.onResume();
		DBHelper.getInstance().createItemValueRecord_Common(GlobalConstants.DB_TABLE_COLUMN_LAST_SCREEN, LoginContainer.class.getName());
	}
}